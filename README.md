...
> Tomcat 6.0.35 32bit is the default version packaged in the **Aware IM 5.9** server installation.
  ...
  + **Java SE Development Kit (JDK)** - [Java Development Kit builds, from Oracle](https://jdk.java.net) - Oracle OpenJDK releases under the open source.
    + [Oracle JDK License Update](https://www.oracle.com/technetwork/java/javase/overview/oracle-jdk-faqs.html). The Oracle JDK License has changed for releases starting April 16, 2019. 
