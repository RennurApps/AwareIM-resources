...
<!--  + [**Download Aware IM**](http://www.awareim.com/download/) - Try Evaluation Version - All platforms. -->
  + [**Currently v8.4 build 2709**](https://www.awareim.com/changelog/Readme2709.txt) - 21 November, 2019. 
...
> Tomcat 6.0.35 32bit is the default version packaged in the **Aware IM 5.9** server installation.
  ...
  + [**Tomcat 9.0.29** - For Aware IM v8.x](http://tomcat.apache.org/) - 16 November, 2019. Tomcat 9 is designed to run on **`Java SE 8`** or later. 
  ...
  + [**Tomcat 8.5** - For Aware IM v6.0+](http://tomcat.apache.org/) - **Latest release is Tomcat v`8.5.49`** 16 November, 2019. (Aware IM bundled version `8.5.24`) - Tomcat 8.5 requires **`Java SE 7`** or later. 
    + [**Download Tomcat**](https://tomcat.apache.org/download-80.cgi#8.5.49)  
  ...
  + [**Java Service Wrapper** - ](http://wrapper.tanukisoftware.com/doc/english/download.jsp) - **32bit v3.5.41** 64-bit Windows versions of the Java Service Wrapper are not currently being made available in the Community Edition. 
...
#### **Web Application Framework** - HTML5/JS Framework
  + [**Kendo UI®**](http://www.telerik.com/kendo-ui) - **Aware IM v7.0+**. JavaScript, HTML5 UI widgets for responsive web and data visualization. 
    ...
    + [**Release History**](http://www.telerik.com/support/whats-new/kendo-ui/release-history)
      + Latest Kendo UI Release [**Kendo UI R3 2019 SP1**](https://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-r3-2019-sp1) - October 23, 2019 
