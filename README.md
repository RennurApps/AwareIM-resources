  ...
  + [**Apache ActiveMQ™**](http://activemq.apache.org/) - The most popular and powerful open source messaging and Integration Patterns server.  
    ...
    + [**Issues**](https://github.com/RennurApps/AwareIM-resources/issues) - Refer to the Issues tab.
      ...
      -->
        ...
        -->
    + **Releases**:
      - [ ] [5.15.7 Release](http://activemq.apache.org/activemq-5157-release.html) - Nov 2018. **Inconsistent vector internals** Aware IM error.  
        - Change Log
...
#### Databases
  + **MySQL**
    + [**MySQL Community Server**](http://www.mysql.com/products/community/)
      + Download
        - [x] [**MySQL Community Server 8.0.13**](http://dev.mysql.com/downloads/mysql/) - 22 Oct 2018. Upgrade from MySQL 5.7 to MySQL 8.0 is only supported using the in-place upgrade method.
        + [x] [**MySQL Community Server 5.7.24**](http://dev.mysql.com/downloads/mysql/) - 22 Oct 2018.
          + **Prerequisite**
 ...
 MySQL 5.7 requires the Microsoft Visual C++ 2013 Redistributable Package to run on Windows platforms.
        + [x] [**MySQL Community Server 5.6.42**](https://dev.mysql.com/downloads/mysql/5.6.html) - 22 Oct 2018.
          + **Prerequisite**
...
#### Database Connectors
  + [**MySQL Connectors**](https://www.mysql.com/products/connector/) - :grey_exclamation:**UPDATE TO VERSION 8.x HIGHLY RECOMMENDED**:grey_exclamation: 
    ...
    + :heavy_check_mark: [**Connector/J 8.0.x**](https://dev.mysql.com/downloads/connector/j/) - **Latest version v8.0.13**, 22 Oct 2018. It supports MySQL `5.5`, `5.6`, `5.7`, and `8.0`. It supports the `JDBC 4.2` specification. It is a MySQL driver for the `Java 8` platform. For `Java 7` or earlier, use `Connector/J 5.1` instead.
...
#### **Web Application Framework** - HTML5/JS Framework
  + [**Kendo UI®**](http://www.telerik.com/kendo-ui) - **Aware IM v7.0+**. JavaScript, HTML5 UI widgets for responsive web and data visualization. 
    ...
    + [**Release History**](http://www.telerik.com/support/whats-new/kendo-ui/release-history)
      + Latest Kendo UI Release [**Kendo UI R3 2018 SP1**](https://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-r3-2018-sp1) - October 17, 2018
