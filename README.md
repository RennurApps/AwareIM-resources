...
<!--  + [**Download Aware IM**](http://www.awareim.com/download/) - Try Evaluation Version - All platforms. -->
  + [**Currently v8.1 build 2475**](http://www.awareim.com/changelog/Readme2475.txt) - 5 Sep, 2018.
    + **Roadmap**
      + **Version 8.2**
...
> Tomcat 6.0.35 32bit is the default version packaged in the **Aware IM 5.9** server installation.
  ...
  + [**Tomcat 9.0.12** - For Aware IM v6.0+](http://tomcat.apache.org/) - 4 Sep, 2018. Tomcat 9 is designed to run on **`Java SE 8`** or later.
  ...
  + [**Apache ActiveMQ™**](http://activemq.apache.org/) - The most popular and powerful open source messaging and Integration Patterns server.  
    ...
    + **Releases**:
      ...
      - [x] [**5.8.0 Release**](http://activemq.apache.org/activemq-580-release.html) - Default version packaged with the server installation.
        + [**Bugs in 5.8.0+**](https://issues.apache.org/jira/browse/AMQ-99?jql=project%20%3D%20AMQ%20AND%20issuetype%20%3D%20Bug%20AND%20status%20in%20(Resolved%2C%20Closed)%20AND%20priority%20in%20(Blocker%2C%20Critical)%20AND%20resolution%20in%20(Fixed%2C%20Resolved)%20AND%20affectedVersion%20in%20(releasedVersions()%2C%205.10.0%2C%205.10.1%2C%205.10.2%2C%205.11.0%2C%205.11.1%2C%205.11.2%2C%205.11.3%2C%205.11.4%2C%205.12.0%2C%205.12.1%2C%205.12.2%2C%205.12.3%2C%205.13.0%2C%205.13.1%2C%205.13.2%2C%205.13.3%2C%205.13.4%2C%205.13.5%2C%205.14.0%2C%205.14.1%2C%205.14.2%2C%205.14.3%2C%205.14.4%2C%205.14.5%2C%205.15.0%2C%205.15.1%2C%205.15.2%2C%205.15.3%2C%205.15.4%2C%205.15.5%2C%205.15.6%2C%205.8.0%2C%205.15.7)%20ORDER%20BY%20affectedVersion%20ASC%2C%20priority%20ASC%2C%20updated%20DESC)
