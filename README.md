...
> Tomcat 6.0.35 32bit is the default version packaged in the **Aware IM 5.9** server installation.
  ...
  + [**Tomcat 9.0.8** - For Aware IM v6.0+](http://tomcat.apache.org/) - Apr 27, 2018. Tomcat 9 is designed to run on **`Java SE 8`** or later.
  ...
  + [**Tomcat 8.5.x** - For Aware IM v6.0+](http://tomcat.apache.org/) - Apr 27, 2018. **Latest version Tomcat v8.5.31** - Tomcat 8.5 requires **`Java SE 7`** or later. 
    + [**Download Tomcat**](https://tomcat.apache.org/download-80.cgi#8.5.30)  
  ...
  + [**Tomcat 8.0.x** - For Aware IM v6.0-v8.0](http://tomcat.apache.org/) - Apr 9, 2018. **Latest version Tomcat v8.0.51** - Tomcat 8.0 requires Java SE 7 or later. 
  ...
  + [**Apache ActiveMQ™**](http://activemq.apache.org/) - The most popular and powerful open source messaging and Integration Patterns server.  
    ...
    -->
    + **Issues**
      + **ERROR: org.openadaptor.adaptor.jms.JMSListener - onMessage: JMSException**
        + **Server Log**
...
#### **Web Application Framework** - HTML5/JS Framework
  + [**Kendo UI®**](http://www.telerik.com/kendo-ui) - **Aware IM v7.0+**. JavaScript, HTML5 UI widgets for responsive web and data visualization. 
    ...
    + [**Release History**](http://www.telerik.com/support/whats-new/kendo-ui/release-history)
      + Latest Kendo UI Release [**Kendo UI R2 2018**](https://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-r2-2018) - May 16, 2018  
...
#### Front-end Framework 
  + **Bootstrap** - For Aware IM version 5.x & 6.x only; Aware IM 7.0 has bootstrap integrated as part of Kendo UI.
    + [Bootstrap v4](https://getbootstrap.com/) - Currently v**4.1.0** - Not tested with AwareIM 6.0 or below. Some v3 features dropped.
