...
<!--  + [**Download Aware IM**](http://www.awareim.com/download/) - Try Evaluation Version - All platforms. -->
  + [**Currently v8.4 build 2710**](https://www.awareim.com/changelog/Readme2710.txt) - 29 November, 2019. 
...
> Tomcat 6.0.35 32bit is the default version packaged in the **Aware IM 5.9** server installation.
  ...
  + **Java SE Development Kit (JDK)**
    + [x] [**Version 8**, Update 231](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html) - October 15, 2019. Download and install. 64bit JDK recommended. 
