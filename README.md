...
<!--  + [**Download Aware IM**](http://www.awareim.com/download/) - Try Evaluation Version - All platforms. -->
  + [**Currently v8.1 build 2469**](http://www.awareim.com/changelog/Readme2468.txt) - 21 Aug, 2018.
    + **Roadmap**
      + **Version 8.2**
...
<!--  + [Purchase a premium support ticket](http://www.awareim.com/support-request/) - For urgent issues requiring a prompt reply from the support team. Alternatively, email support directly at **support [at] awareim [dot] com** -->
  ...
  + [**Video Tutorials**](http://www.awareim.com/video-tutorials/) - Highly Recommended
    ...
    + **Version 5.9+**
      + [**What's New in 5.9**](http://www.awareim.com/tutorials/59/New%20In%205,9.html) 
...
> Tomcat 6.0.35 32bit is the default version packaged in the **Aware IM 5.9** server installation.
  ...
  + [**Tomcat 9.0.11** - For Aware IM v6.0+](http://tomcat.apache.org/) - 11 Aug, 2018. Tomcat 9 is designed to run on **`Java SE 8`** or later.
...
<!--            - [x] **In 8.1**, Rename the extracted `ecj-4.x.jar`to `ecj-4.6.3.jar` found in the Tomcat/lib folder -->
            - [x] **In 6.0**, Rename the extracted `ecj-4.x.jar`to `ecj-4.4.jar` found in the Tomcat/lib folder          
  ...
  + **Java SE Development Kit (JDK)**
    + [x] [**Version 8**, Update 181 (JDK 1.8.0_181-b13)](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html) - July 17, 2018. Download and install. 64bit JDK recommended. 
  ...
  + [**Apache ActiveMQ™**](http://activemq.apache.org/) - The most popular and powerful open source messaging and Integration Patterns server.  
    ...
    + **Releases**:
      ...
      - [x] [**5.8.0 Release**](http://activemq.apache.org/activemq-580-release.html) - Default version packaged with the server installation.
        + [**Bugs in 5.8.0**](https://issues.apache.org/jira/browse/AMQ-4595?jql=project%20%3D%20AMQ%20AND%20issuetype%20%3D%20Bug%20AND%20status%20in%20(Resolved%2C%20Closed)%20AND%20priority%20in%20(Blocker%2C%20Critical)%20AND%20resolution%20in%20(Fixed%2C%20Resolved)%20AND%20affectedVersion%20in%20(5.12.1%2C%205.12.2%2C%205.12.3%2C%205.13.0%2C%205.13.1%2C%205.13.2%2C%205.13.3%2C%205.13.4%2C%205.13.5%2C%205.14.0%2C%205.14.1%2C%205.14.2%2C%205.14.3%2C%205.14.4%2C%205.14.5%2C%205.15.0%2C%205.15.1%2C%205.15.2%2C%205.15.3%2C%205.15.4%2C%205.15.5%2C%205.8.0)%20ORDER%20BY%20affectedVersion%20ASC%2C%20priority%20ASC%2C%20updated%20DESC)
...
#### Databases
  + **MySQL**
    + [**MySQL Community Server**](http://www.mysql.com/products/community/)
      + Download
        - [x] [**MySQL Community Server 8.0.12**](http://dev.mysql.com/downloads/mysql/) - 27 Jul 2018. Upgrade from MySQL 5.7 to MySQL 8.0 is only supported using the in-place upgrade method.
        + [x] [**MySQL Community Server 5.7.23**](http://dev.mysql.com/downloads/mysql/) - 27 Jul 2018.
          + **Prerequisite**
 ...
 MySQL 5.7 requires the Microsoft Visual C++ 2013 Redistributable Package to run on Windows platforms.
        + [x] [**MySQL Community Server 5.6.41**](https://dev.mysql.com/downloads/mysql/5.6.html) - 27 Jul 2018.
          + **Prerequisite**
        ...
        + [x] [**MySQL Community Server 5.5.61**](https://dev.mysql.com/downloads/mysql/5.5.html) - 27 Jul 2018.
...
#### Database Connectors
  + [**MySQL Connectors**](https://www.mysql.com/products/connector/) - :grey_exclamation:**UPDATE TO VERSION 8.x HIGHLY RECOMMENDED**:grey_exclamation: 
      ...
      + [Connector/J Versions](https://dev.mysql.com/doc/connector-j/8.0/en/connector-j-versions.html) and what MySQL and Java JDK Versions they suppor.

    + :heavy_check_mark: [**Connector/J 8.0.x**](https://dev.mysql.com/downloads/connector/j/) - **Latest version v8.0.12**, 27 Jul 2018. It supports MySQL `5.5`, `5.6`, `5.7`, and `8.0`. It supports the `JDBC 4.2` specification. It is a MySQL driver for the `Java 8` platform. For `Java 7` or earlier, use `Connector/J 5.1` instead.
...
#### **Web Application Framework** - HTML5/JS Framework
  + [**Kendo UI®**](http://www.telerik.com/kendo-ui) - **Aware IM v7.0+**. JavaScript, HTML5 UI widgets for responsive web and data visualization. 
    ...
    + [**Release History**](http://www.telerik.com/support/whats-new/kendo-ui/release-history)
      + Latest Kendo UI Release [**Kendo UI R2 2018 SP1**](https://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-r2-2018-sp1) - Jun 20, 2018
        + jQuery Library Updates
          + Top-most voted feedback item to our list of UI components: the [**DropDownTree**](https://www.telerik.com/support/whats-new/kendo-ui).
      + Current **Aware IM 8.1** Kendo UI version [**Kendo UI R3 2017**](https://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-r3-2017) - September 13, 2017 
      + Current **Aware IM 7.0-8.0** Kendo UI version [**Kendo UI Q1 2016**](http://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-q1-2016) - January 12, 2016 
...
#### Front-end Framework 
  + **Bootstrap** - For Aware IM version 5.x & 6.x only; Aware IM 7.0 has bootstrap integrated as part of Kendo UI.
    + [Bootstrap v4](https://getbootstrap.com/) - Currently v**4.1.3** - Not tested with AwareIM 6.0 or below. Some v3 features dropped.
