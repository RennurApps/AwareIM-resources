...
> Tomcat 6.0.35 32bit is the default version packaged in the **Aware IM 5.9** server installation.
  ...
  + [**Tomcat 9.0.27** - For Aware IM v8.x](http://tomcat.apache.org/) - 7 October, 2019. Tomcat 9 is designed to run on **`Java SE 8`** or later. 
  ...
  + [**Tomcat 8.5** - For Aware IM v6.0+](http://tomcat.apache.org/) - **Latest release is Tomcat v`8.5.47`** 7 October, 2019. (Aware IM bundled version `8.5.24`) - Tomcat 8.5 requires **`Java SE 7`** or later. 
    + [**Download Tomcat**](https://tomcat.apache.org/download-80.cgi#8.5.47)  
