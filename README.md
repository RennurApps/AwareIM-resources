...
Written in 100% Java programming language. Aware IM is based on the plethora of Java technologies such as J2EE application server, JDBC, JMS, JSP/servlets technology, web services etc. These are robust technologies that have been proven in the industry.
  ...
  + [**Download Aware IM**](http://www.awareim.com/download/) - Try Evaluation Version - All platforms.
    + [**Currently v8.0 build 2355**](http://www.awareim.com/changelog/Readme2355.txt) - 12 Sep, 2017.
...
> Tomcat 6.0.35 32bit is the default version packaged in the **Aware IM 5.9** server installation.
  ...
  + **Java™ SE Development Kit (JDK)**
    + [Version 8, Update 144 (JDK 8u144)](http://www.oracle.com/technetwork/java/javase/downloads/index.html) - July 26, 2017. Download and install. 64bit JDK recommended. JDK version bundled with the default installation is unknown. Java claims increase in performance with v8+.
  ...
  + [**Apache ActiveMQ™**](http://activemq.apache.org/) - The most popular and powerful open source messaging and Integration Patterns server.  
    ...
    + **Vulnerabilities** - Apache ActiveMQ `5.12.1` and `older versions`. Aware IM **v8.0 build 2357+** installations must use the bundled ActiveMQ `**v5.8.0**`. 
