...
Written in 100% Java programming language. Aware IM is based on the plethora of Java technologies such as J2EE application server, JDBC, JMS, JSP/servlets technology, web services etc. These are robust technologies that have been proven in the industry.
  ...
  + [**Download Aware IM**](http://www.awareim.com/download/) - Try Evaluation Version - All platforms.
   + [**Currently v8.0 build 2374**](http://www.awareim.com/changelog/Readme2374.txt) - 22 Dec, 2017.
...
#### Developer Community
  + **2018 Aware IM International Delevopers Conference - USA**
    + [**Event Information & Registration**](http://events.eventzilla.net/e/2018-aware-im-developers-international-conference--providence-rhode-island-usa-2138920675?resp=on&dateid=2138795244) - March 31 2018 - April 05 2018. 220 India Street, Providence, Rhode Island, United States
...
> Tomcat 6.0.35 32bit is the default version packaged in the **Aware IM 5.9** server installation.
  ...
  + [**Tomcat 9.0.2** - For Aware IM v6.0+](http://tomcat.apache.org/) - Nov 25, 2017. Tomcat 9 is designed to run on **`Java SE 8`** or later.
  ...
  + [**Tomcat 8.5.x** - For Aware IM v6.0+](http://tomcat.apache.org/) - Nov 27, 2017. **Latest version Tomcat v8.5.24** - Tomcat 8.5 requires **`Java SE 7`** or later. 
    + [**Download Tomcat**](https://tomcat.apache.org/download-80.cgi#8.5.24)  
  ...
  + [**Tomcat 8.0.x** - For Aware IM v6.0+](http://tomcat.apache.org/) - Nov 30, 2017. **Latest version Tomcat v8.0.48** - Tomcat 8.0 requires Java SE 7 or later. 
    + [**Download Tomcat**](https://tomcat.apache.org/download-80.cgi#8.0.48) - 64bit recommended. Manual Install. **Tested and working**.
...
#### Front-end Framework 
  + **Bootstrap** - For Aware IM version 5.x & 6.x only; Aware IM 7.0 has bootstrap integrated as part of Kendo UI.
    + [Bootstrap v4-beta](https://getbootstrap.com/) - Currently v4.0.0-beta.3 - Not tested with AwareIM 6.0 or below. Some v3 features dropped.
