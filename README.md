...
<!--  + [**Download Aware IM**](http://www.awareim.com/download/) - Try Evaluation Version - All platforms. -->
  + [**Currently v8.3 build 2615**](https://www.awareim.com/changelog/Readme2615.txt) - 30 May, 2019. 
    ...
    + 8.3 Recent Improvements
      + 2065 - Predefined elements use default output target for the content panel
...
> Tomcat 6.0.35 32bit is the default version packaged in the **Aware IM 5.9** server installation.
  ...
  + [**Tomcat 9.0.20** - For Aware IM v6.0+](http://tomcat.apache.org/) - 3 May, 2019. Tomcat 9 is designed to run on **`Java SE 8`** or later.
  ...
  + [**Tomcat 8.5.x** - For Aware IM v6.0+](http://tomcat.apache.org/) - 3 May, 2019. **Latest release is Tomcat v`8.5.41`** (Aware IM bundled version `8.5.24`) - Tomcat 8.5 requires **`Java SE 7`** or later. 
    + [**Download Tomcat**](https://tomcat.apache.org/download-80.cgi#8.5.41)  
...
#### Databases
  + **MySQL**
    + [**MySQL Community Server**](http://www.mysql.com/products/community/)
      + Download
        ...
        + [x] [**MySQL Community Server 5.7.26**](https://dev.mysql.com/downloads/mysql/5.7.html) - 25 Apr 2019.
          + **Prerequisite**
 ...
 MySQL 5.7 requires the Microsoft Visual C++ 2013 Redistributable Package to run on Windows platforms.
        + [x] [**MySQL Community Server 5.6.44**](https://dev.mysql.com/downloads/mysql/5.6.html) - 25 Apr 2019.
          + **Prerequisite**
...
#### Database Connectors
  + [**MySQL Connectors**](https://www.mysql.com/products/connector/) - :grey_exclamation:**UPDATE TO VERSION 8.x HIGHLY RECOMMENDED**:grey_exclamation: 
    ...
    + :heavy_check_mark: [**Connector/J 8.0.x**](https://dev.mysql.com/downloads/connector/j/) - **Latest version v8.0.16**, 25 Apr 2019. It supports MySQL `5.5`, `5.6`, `5.7`, and `8.0`. It supports the `JDBC 4.2` specification. It is a MySQL driver for the `Java 8` platform. For `Java 7` or earlier, use `Connector/J 5.1` instead.
...
#### **Web Application Framework** - HTML5/JS Framework
  + [**Kendo UI®**](http://www.telerik.com/kendo-ui) - **Aware IM v7.0+**. JavaScript, HTML5 UI widgets for responsive web and data visualization. 
    ...
    + [**Release History**](http://www.telerik.com/support/whats-new/kendo-ui/release-history)
      + Latest Kendo UI Release [**Kendo UI R1 2019 SP1**](https://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-r1-2019-sp1) - February 20, 2019
