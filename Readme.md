...
#### [**⚠️ Tomcat `11.0.7`**](http://tomcat.apache.org/) - 7 May, 2025. Tomcat 10 is designed to run on `Java SE 11 or later`

- [**Download Tomcat v11**](https://tomcat.apache.org/download-11.cgi) - 64bit recommended. Manual Install required.

#### [**⚠️ Tomcat `10.1.41`**](http://tomcat.apache.org/) - 8 May, 2025. Tomcat 10 is designed to run on `Java SE 11 or later`
...
#### [**✔️ Tomcat `9.0.105`**](http://tomcat.apache.org/) - **7 May, 2025. Tomcat 9 is designed to run on `Java SE 8 or later`**
...
- **PostgreSQL**
  ...
  - [Download](https://www.enterprisedb.com/downloads/postgres-postgresql-downloads) - Version `17.4` <!-- https://endoflife.date/postgresql -->

- **Maria DB**

  - [**MariaDB**](https://mariadb.org/) - Free and open-source software under the GNU General Public License.
  - [Download](https://mariadb.org/download/) - Version `11.7.32`.
