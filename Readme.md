...
* [**Tomcat 8.5** - For Aware IM v6.0+](http://tomcat.apache.org/) - **Latest release is Tomcat v`8.5.64`** 4 March, 2021. (Aware IM bundled version `8.5.58`) - Tomcat 8.5 requires **`Java SE 7`** or later.
