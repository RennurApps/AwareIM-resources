...
* :warning: [**Tomcat 10.0.16**](http://tomcat.apache.org/) - Tomcat 10 is designed to run on **`Java SE 8`** or later.
...
* ✔️ [**Tomcat 9.0.58** - For Aware IM v8.x](http://tomcat.apache.org/) - 215 January, 2022. Tomcat 9 is designed to run on **`Java SE 8`** or later.
...
- [**Commercial Java SE Development Kit (JDK)**](https://www.oracle.com/technetwork/java/javase/overview/index.html) - [Important Oracle JDK License Update starting April 16, 2019](https://www.oracle.com/technetwork/java/javase/overview/oracle-jdk-faqs.html)
  - ✔️ [Version `17.0.2`](https://www.oracle.com/java/technologies/downloads/) - **Works with Aware IM version `8.6`**. 
  ...
  - ✔️ [**Version 8, Update 321**](https://www.oracle.com/java/technologies/javase/javase-jdk8-downloads.html) - **Compatible with Aware IM versions `6.0` - `8.5`**. <!-- More Download links found at [https://lv.binarybabel.org/catalog/java/jdk8](https://lv.binarybabel.org/catalog/java/jdk8) -->
...
- [**Apache ActiveMQ™**](http://activemq.apache.org/) - The most popular and powerful open source messaging and Integration Patterns server. Apache [ActiveMQ](https://en.wikipedia.org/wiki/Apache_ActiveMQ) is an open source message broker written in Java together with a full Java Message Service (JMS) client.
  ...
  - **Releases**:
    - ⚠️ [5.16.3 Release](https://activemq.apache.org/activemq-5016003-release) - 17 August, 2021. **Inconsistent vector internals** Aware IM error.
      - ERROR:
...
- [**Java Service Wrapper** -](http://wrapper.tanukisoftware.com/doc/english/download.jsp) \- **32bit v3.5.46** 64-bit Windows versions of the Java Service Wrapper are not currently being made available in the Community Edition.
...
- [**Kendo UI®**](https://www.telerik.com/kendo-ui) - **Aware IM `v7.0`+**. JavaScript, HTML5 UI widgets for responsive web and data visualization.
  ...
  - [**Release History - jQuery**](https://www.telerik.com/support/whats-new/kendo-ui/release-history)
    - Latest Kendo UI Release [**Kendo UI R3 2021 SP2**](https://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-r3-2021-sp2-(version-2021-3-1207) - December 7, 2021 `version 2021.3.1109`
