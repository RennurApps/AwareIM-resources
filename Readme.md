...
#### [**⚠️ Tomcat `11.0.8`**](http://tomcat.apache.org/) - 5 June, 2025. Tomcat 10 is designed to run on `Java SE 11 or later`

- [**Download Tomcat v11**](https://tomcat.apache.org/download-11.cgi) - 64bit recommended. Manual Install required.

#### [**⚠️ Tomcat `10.1.42`**](http://tomcat.apache.org/) - 5 June, 2025. Tomcat 10 is designed to run on `Java SE 11 or later`
...
#### [**✔️ Tomcat `9.0.106`**](http://tomcat.apache.org/) - **5 June, 2025. Tomcat 9 is designed to run on `Java SE 8 or later`**
