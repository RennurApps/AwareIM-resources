...
*   [**Tomcat 9.0.34** - For Aware IM v8.x](http://tomcat.apache.org/) - 3 Apr, 2020. Tomcat 9 is designed to run on **`Java SE 8`** or later.
...
*   #### [](#mysql)**MySQL**
    ...
    *   [**MySQL Community Server**](http://www.mysql.com/products/community/)
        *   Download
            ...
            *    [**MySQL Community Server 8.0.19**](http://dev.mysql.com/downloads/mysql/) - 13 Jan 2020. Upgrade from MySQL 5.7 to MySQL 8.0 is only supported using the in-place upgrade method.
                *   **Prerequisite**
                    *   [Visual Studio 2015, 2017 and 2019](https://support.microsoft.com/en-au/help/2977003/the-latest-supported-visual-c-downloads)
            
            *    [**MySQL Community Server 5.7.29**](https://dev.mysql.com/downloads/mysql/5.7.html) - 13 Jan 2020.
                *   **Prerequisite**
            ...
            *    [**MySQL Community Server 5.6.47**](https://dev.mysql.com/downloads/mysql/5.6.html) - 13 Jan 2020.
                *   **Prerequisite**
...
*   #### [](#mysql-connectors---grey_exclamationupdate-to-version-8x-highly-recommendedgrey_exclamation)[**MySQL Connectors**](https://www.mysql.com/products/connector/) - ❕**UPDATE TO VERSION 8.x HIGHLY RECOMMENDED**❕
    ...
    *   ✔️ [**Connector/J 8.0.x**](https://dev.mysql.com/downloads/connector/j/) - **Latest version `v8.0.19`**, 13 Jan 2020. It supports MySQL `5.5`, `5.6`, `5.7`, and `8.0`. It supports the `JDBC 4.2` specification. It is a MySQL driver for the `Java 8` platform. For `Java 7` or earlier, use `Connector/J 5.1` instead.
        ...
        *   **Installation**
            *   Application Server
                ...
                3.  Copy and replace the existing file in:
                    ...
                    *   **v8.2 and below**, `C:\AwareIM\Tomcat\lib`
                4.  Restart AwareIM Server Control Panel
*   #### [](#postgresql-jdbc-connector---current-version-42210)[**PostgreSQL JDBC Connector**](https://jdbc.postgresql.org/download.html) - Current version `42.2.10`.
...
*   **Electronic Signature Capture** - For Aware IM 5.9+
    ...
    *   [✔️ **Signature Pad v1.5.3**](https://github.com/RennurApps/AwareIM-resources/tree/master/Signature) - Tested and working in all versions 5.9+
    *   **Installation**:
