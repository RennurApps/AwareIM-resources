...
* :warning: [**Tomcat 10.0.17**](http://tomcat.apache.org/) - Tomcat 10 is designed to run on **`Java SE 8`** or later.
...
* ✔️ [**Tomcat 9.0.59** - For Aware IM v8.x](http://tomcat.apache.org/) - 21 February, 2022. Tomcat 9 is designed to run on **`Java SE 8`** or later.
...
- [**Kendo UI®**](https://www.telerik.com/kendo-ui) - **Aware IM `v7.0`+**. JavaScript, HTML5 UI widgets for responsive web and data visualization.
  ...
  - [**Release History - jQuery**](https://www.telerik.com/support/whats-new/kendo-ui/release-history)
    - Latest Kendo UI Release [**Kendo UI R1 2022**](https://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-r1-2022-(version-2022-1-119)) - January 19, 2022 
