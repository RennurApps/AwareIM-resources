...
#### [**⚠️ Tomcat `10.1.29`**](http://tomcat.apache.org/) - 5 Sep, 2024. Tomcat 10 is designed to run on `Java SE 11 or later`
...
#### [**✔️ Tomcat `9.0.94`**](http://tomcat.apache.org/) - **5 September, 2024. Tomcat 9 is designed to run on `Java SE 8 or later`**
