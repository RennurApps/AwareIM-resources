...
* :warning: [**Tomcat 10.1.9**](http://tomcat.apache.org/) - Tomcat 10 is designed to run on **`Java SE 8`** or later.
...
* ✔️ [**Tomcat 9.0.75** - For Aware IM v8.x](http://tomcat.apache.org/) - 4 May, 2023. Tomcat 9 is designed to run on **`Java SE 8`** or later.
...
* 📉 [**Tomcat 8.5** - For Aware IM v6.0+](http://tomcat.apache.org/) - **Latest release is Tomcat v`8.5.87`** 27 February, 2022. - Tomcat 8.5 requires **`Java SE 7`** or later.
