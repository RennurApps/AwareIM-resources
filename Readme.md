...
* :warning: [**Tomcat 10.1.25**](http://tomcat.apache.org/) - Tomcat 10 is designed to run on **`Java SE 8`** or later.
...
* ✔️ [**Tomcat 9.0.71** - For Aware IM v8.x](http://tomcat.apache.org/) - 9 Jan, 2023. Tomcat 9 is designed to run on **`Java SE 8`** or later.
