...
#### [**⚠️ Tomcat 10.1.16**](http://tomcat.apache.org/) - **10 November, 2023. Tomcat 10 is designed to run on `Java SE 11 or later`**
...
#### [**✔️ Tomcat 9.0.83**](http://tomcat.apache.org/) - **9 November, 2023. Tomcat 9 is designed to run on `Java SE 8 or later`**
...
- [**Apache ActiveMQ™**](http://activemq.apache.org/) - The most popular and powerful open source messaging and Integration Patterns server. Apache [ActiveMQ](https://en.wikipedia.org/wiki/Apache_ActiveMQ) is an open source message broker written in Java together with a full Java Message Service (JMS) client.
  ...
  - **Releases**:
    - ⚠️ [5.18.3 Release](https://activemq.apache.org/activemq-5018002-release) - 25 October, 2023. Java 11+ required.
    - ⚠️ [5.17.6 Release](https://activemq.apache.org/activemq-5017005-release) - 25 October, 2023. Java 11+ required.
...
- **Maria DB**
  ...
  - [Download](https://mariadb.org/download/) - Version `11.1.3`.
...
- [**Kendo UI®**](https://www.telerik.com/kendo-ui) - Kendo UI for jQuery delivers everything you need for data handling, data grids, forms, navigation, performance, UX, design, accessibility, and so much more.
  ...
  - [**Release History - jQuery**](https://www.telerik.com/support/whats-new/kendo-ui/release-history)
    - Latest Kendo UI Release [**Kendo UI R3 2023**](<https://www.telerik.com/support/whats-new/kendo-ui/release-history/kendo-ui-r3-2023-(version-2023-3-1010)>) - October 9, 2023
